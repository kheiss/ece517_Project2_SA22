...
# -----------------------------------------------------------------------------
# Check the validity of entered Mobile Phone data
...
auth.settings.register_onaccept = auth.s3_register
...
def index():
    ...
    menu_btns = [#div, label, app, function
                ...
                ["sit", T("Assessments"), "assess", "assess"],
                ...
                ["res", T("Activities"), "project", "assess"],
