...
$(document).ready(function(){void 0!=$(".advanced-form").val()&&(void 0==$(".simple-form").val()?($(".simple-form").hide(),$(".advanced-form").show()):($(".advanced-form").hide(),$(".advanced-lnk").click(function(a){a.preventDefault();a=$('.search_form[fieldname="'+$(this).attr("fieldname")+'"]');a.length==0&&(a=$(".search_form"));a.find(".simple-form").hide();a.find(".advanced-form").show();return!1}),$(".simple-lnk").click(function(a){a.preventDefault();a=$('.search_form[fieldname="'+$(this).attr("fieldname")+
'"]');a.length==0&&(a=$(".search_form"));a.find(".advanced-form").hide();a.find(".simple-form").show();return!1})));$(".search_select_letter_label").click(function(){$("#"+selSearchDiv.attr("id").replace("label","widget")).slideToggle();$(this).toggleClass("expanded")});$("div.simple-form").keyup(fncSearchAutocompleteTimer).click(fncSearchAutocompleteTimer).keypress(CancelEnterPress);$("div.advanced-form").keyup(fncSearchAutocompleteTimer).click(fncSearchAutocompleteTimer).keypress(CancelEnterPress);
