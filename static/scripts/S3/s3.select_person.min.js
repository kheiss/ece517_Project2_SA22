...
$("#clear_form_link").addClass("hide");$("#person_load_throbber").removeClass("hide");clear_person_form();a=S3.Ap.concat("/"+h+"/person/"+a+".s3json");$.getJSONS3(a,function(a){try{person=a.$_pr_person[0];f();$(c).val(person["@id"]);person.hasOwnProperty("first_name")&&$("#pr_person_first_name").val(person.first_name);person.hasOwnProperty("middle_name")&&$("#pr_person_middle_name").val(person.middle_name);person.hasOwnProperty("last_name")&&$("#pr_person_last_name").val(person.last_name);person.hasOwnProperty("gender")&&
$("#pr_person_gender").val(person.gender["@value"]);person.hasOwnProperty("date_of_birth")&&$("#pr_person_date_of_birth").val(person.date_of_birth["@value"]);person.hasOwnProperty("occupation")&&$("#pr_person_occupation").val(person.occupation);try{$.each(person.$_pr_contact,function(){method=this.contact_method["@value"];b=this.value;typeof b!=="undefined"&&(method=='"EMAIL"'?$("#pr_person_email").val(b):method=='"SMS"'&&$("#pr_person_mobile_phone").val(b))})}catch(d){}}catch(e){$(c).val("")}$("#person_load_throbber").addClass("hide");
$("#select_from_registry").removeClass("hide");$("#clear_form_link").removeClass("hide");$("#edit_selected_person_link").removeClass("hide")});$("#person_autocomplete_row").addClass("hide");$("#select_from_registry_row").removeClass("hide")};b!="None"&&($(c).val(b),select_person(b));$("form").submit(function(){S3ClearNavigateAwayConfirm();d();return!0})});
