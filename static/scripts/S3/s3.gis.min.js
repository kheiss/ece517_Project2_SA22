...
Ext.onReady(function(){addMap();if(void 0==S3.gis.west_collapsed)S3.gis.west_collapsed=!1;items=[S3.gis.layerTree];S3.gis.wmsBrowser&&items.push(S3.gis.wmsBrowser);S3.gis.searchCombo&&items.push(S3.gis.searchCombo);S3.gis.printFormPanel&&items.push(S3.gis.printFormPanel);S3.gis.legendPanel&&items.push(S3.gis.legendPanel);for(var a=0;a<S3.gis.plugins.length;++a)S3.gis.plugins[a].addToMapWindow(items);S3.gis.window?addMapWindow(items):addMapPanel(items);S3.gis.bounds&&map.zoomToExtent(S3.gis.bounds);
Ext.QuickTips.init()});
function addMap(){map=new OpenLayers.Map("center",S3.gis.options);addLayers();addControls();S3.gis.mapPanel=new GeoExt.MapPanel({region:"center",height:S3.gis.map_height,width:S3.gis.map_width,id:"mappanel",xtype:"gx_mappanel",map:map,center:S3.gis.center,zoom:S3.gis.zoom,plugins:[]});S3.gis.mapPanelContainer=new Ext.Panel({layout:"card",region:"center",id:"mappnlcntr",defaults:{border:!1},items:[S3.gis.mapPanel],activeItem:0,tbar:new Ext.Toolbar,scope:this});if(S3.gis.Google&&S3.gis.Google.Earth)S3.gis.googleEarthPanel=
new gxp.GoogleEarthPanel({mapPanel:S3.gis.mapPanel}),S3.gis.mapPanelContainer.items.items.push(S3.gis.googleEarthPanel);addLayerTree();S3.gis.toolbar&&addToolbar();S3.gis.wms_browser_url&&addWMSBrowser();if(S3.i18n.gis_legend)S3.gis.legendPanel=new GeoExt.LegendPanel({id:"legendpanel",title:S3.i18n.gis_legend,defaults:{labelCls:"mylabel",style:"padding:5px"},bodyStyle:"padding:5px",autoScroll:!0,collapsible:!0,collapseMode:"mini",lines:!1});if(S3.i18n.gis_search){var a=new GeoExt.ux.GeoNamesSearchCombo({map:map,
zoom:12});S3.gis.searchCombo=new Ext.Panel({id:"searchCombo",title:S3.i18n.gis_search,layout:"border",rootVisible:!1,split:!0,autoScroll:!0,collapsible:!0,collapseMode:"mini",lines:!1,html:S3.i18n.gis_search_no_internet,items:[{region:"center",items:[a]}]})}for(a=0;a<S3.gis.plugins.length;++a)S3.gis.plugins[a].setup(map)}
function addMapPanel(a){S3.gis.mapWin=new Ext.Panel({id:"gis-map-panel",renderTo:"map_panel",autoScroll:!0,maximizable:!0,titleCollapse:!0,height:S3.gis.map_height,width:S3.gis.map_width,layout:"border",items:[{region:"west",id:"tools",header:!1,border:!0,width:250,autoScroll:!0,collapsible:!0,collapseMode:"mini",collapsed:S3.gis.west_collapsed,split:!0,items:a},S3.gis.mapPanelContainer]})}
function addMapWindow(a){S3.gis.mapWin=new Ext.Window({id:"gis-map-window",collapsible:!0,constrain:!0,closeAction:"hide",autoScroll:!0,maximizable:!0,titleCollapse:!0,height:S3.gis.map_height,width:S3.gis.map_width,layout:"border",items:[{region:"west",id:"tools",header:!1,border:!0,width:250,autoScroll:!0,collapsible:!0,collapseMode:"mini",collapsed:S3.gis.west_collapsed,split:!0,items:a},S3.gis.mapPanelContainer]});a=S3.gis.mapWin;if(!S3.gis.windowHide){if(S3.gis.windowNotClosable)a.closable=!1;
a.show();a.maximize()}}
function addLayerTree(){var a=new Ext.tree.AsyncTreeNode({expanded:!0,children:[{text:S3.i18n.gis_base_layers,nodeType:"gx_baselayercontainer",layerStore:S3.gis.mapPanel.layers,leaf:!1,expanded:!0},{text:S3.i18n.gis_overlays,nodeType:"gx_overlaylayercontainer",layerStore:S3.gis.mapPanel.layers,leaf:!1,expanded:!0}]});S3.gis.layerTree=new Ext.tree.TreePanel({id:"treepanel",title:S3.i18n.gis_layers,loader:new Ext.tree.TreeLoader({applyLoader:!1}),root:a,rootVisible:!1,split:!0,autoScroll:!0,collapsible:!0,
collapseMode:"mini",lines:!1,enableDD:!0})}
...
function addGeoJSONLayer(a){var b=a.name,c=a.url;if(void 0!=a.marker_image)var d=S3.gis.marker_url+a.marker_image,e=a.marker_height,f=a.marker_width;else d="";var g=void 0!=a.refresh?a.refresh:900,h=void 0!=a.visibility?a.visibility:!0,j=void 0!=a.opacity?a.opacity:1,l=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance,k=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold,a=void 0!=a.projection?a.projection:4326,a=4326==a?S3.gis.proj4326:new OpenLayers.Projection("EPSG:"+
a),j=new OpenLayers.Style({label:"${label}",pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:j,strokeColor:"${stroke}",strokeWidth:2,strokeOpacity:j,graphicWidth:"${graphicWidth}",graphicHeight:"${graphicHeight}",graphicXOffset:"${graphicXOffset}",graphicYOffset:"${graphicYOffset}",graphicOpacity:j,graphicName:"${graphicName}",externalGraphic:"${externalGraphic}"},{context:{graphicWidth:function(a){return a.cluster?"":a.attributes.marker_width?a.attributes.marker_width:f},graphicHeight:function(a){return a.cluster?
...
Math.min(a.attributes.count/2,8)+12:a.attributes.size?a.attributes.size:12},fill:function(a){return a.cluster?"#8087ff":a.attributes.colour?a.attributes.colour:"#f5902e"},stroke:function(a){return a.cluster?"#2b2f76":a.attributes.colour?a.attributes.colour:"#f5902e"},label:function(a){var b="";if(a.cluster&&a.attributes.count>1)b=a.attributes.count;return b}}}),j=new OpenLayers.StyleMap({"default":j,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}}),b=new OpenLayers.Layer.Vector(b,{projection:a,
strategies:[new OpenLayers.Strategy.BBOX,new OpenLayers.Strategy.Refresh({force:!0,interval:g*1E3}),new OpenLayers.Strategy.Cluster({distance:l,threshold:k})],styleMap:j,protocol:new OpenLayers.Protocol.HTTP({url:c,format:S3.gis.format_geojson})});b.setVisibility(h);b.events.on({featureselected:onGeojsonFeatureSelect,featureunselected:onFeatureUnselect});map.addLayer(b);S3.gis.layers_all.push(b)}
function addGoogleLayers(){var a=S3.gis.Google,b;a.MapMaker||a.MapMakerHybrid?(a.Satellite&&(b=new OpenLayers.Layer.Google(a.Satellite,{type:G_SATELLITE_MAP,sphericalMercator:!0}),map.addLayer(b)),a.Maps&&(b=new OpenLayers.Layer.Google(a.Maps,{type:G_NORMAL_MAP,sphericalMercator:!0}),map.addLayer(b)),a.Hybrid&&(b=new OpenLayers.Layer.Google(a.Hybrid,{type:G_HYBRID_MAP,sphericalMercator:!0}),map.addLayer(b)),a.Terrain&&(b=new OpenLayers.Layer.Google(a.Terrain,{type:G_PHYSICAL_MAP,sphericalMercator:!0}),
map.addLayer(b)),a.MapMaker&&(b=new OpenLayers.Layer.Google(a.MapMaker,{type:G_MAPMAKER_NORMAL_MAP,sphericalMercator:!0}),map.addLayer(b)),a.MapMakerHybrid&&(b=new OpenLayers.Layer.Google(a.MapMakerHybrid,{type:G_MAPMAKER_HYBRID_MAP,sphericalMercator:!0}),map.addLayer(b))):(a.Satellite&&(b=new OpenLayers.Layer.Google(a.Satellite,{type:a.maps.MapTypeId.SATELLITE,numZoomLevels:22}),map.addLayer(b)),a.Maps&&(b=new OpenLayers.Layer.Google(a.Maps,{numZoomLevels:20}),map.addLayer(b)),a.Hybrid&&(b=new OpenLayers.Layer.Google(a.Hybrid,
{type:a.maps.MapTypeId.HYBRID,numZoomLevels:20}),map.addLayer(b)),a.Terrain&&(b=new OpenLayers.Layer.Google(a.Terrain,{type:a.maps.MapTypeId.TERRAIN}),map.addLayer(b)))}
function addGPXLayer(a){var b=a.name,c=a.url,d=S3.gis.marker_url+a.marker_image,e=a.marker_height,f=a.marker_width,g=void 0!=a.waypoints?a.waypoints:!0,h=void 0!=a.tracks?a.tracks:!0,j=void 0!=a.routes?a.routes:!0,l=void 0!=a.visibility?a.visibility:!0,k=void 0!=a.opacity?a.opacity:1,n=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance,a=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold,m=OpenLayers.Util.extend({},OpenLayers.Feature.Vector.style["default"]);
g?(m.graphicOpacity=k,m.graphicWidth=f,m.graphicHeight=e,m.graphicXOffset=-(f/2),m.graphicYOffset=-e,m.externalGraphic=d):m.externalGraphic="";m.strokeColor="blue";m.strokeWidth=6;m.strokeOpacity=k;b=new OpenLayers.Layer.Vector(b,{projection:S3.gis.proj4326,strategies:[new OpenLayers.Strategy.Fixed,new OpenLayers.Strategy.Cluster({distance:n,threshold:a})],style:m,protocol:new OpenLayers.Protocol.HTTP({url:c,format:new OpenLayers.Format.GPX({extractAttributes:!0,extractWaypoints:g,extractTracks:h,
extractRoutes:j})})});b.setVisibility(l);b.events.on({featureselected:onGpxFeatureSelect,featureunselected:onFeatureUnselect});map.addLayer(b);S3.gis.layers_all.push(b)}
function addKMLLayer(a){var b=a.name,c=a.url,d=S3.gis.marker_url+a.marker_image,e=void 0!=a.title?a.title:"name",f=void 0!=a.body?a.body:"description",g=void 0!=a.refresh?a.refresh:900,h=void 0!=a.visibility?a.visibility:!0,j=void 0!=a.opacity?a.opacity:1,l=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance,a=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold;S3.gis.image=new Image;S3.gis.image.onload=s3_gis_scaleImage;S3.gis.image.src=d;var k=OpenLayers.Util.extend({},
OpenLayers.Feature.Vector.style["default"]);k.graphicOpacity=j;k.graphicWidth=S3.gis.image.width;k.graphicHeight=S3.gis.image.height;k.graphicXOffset=-(S3.gis.image.width/2);k.graphicYOffset=-S3.gis.image.height;k.externalGraphic=d;b=new OpenLayers.Layer.Vector(b,{projection:S3.gis.proj4326,strategies:[new OpenLayers.Strategy.Fixed,new OpenLayers.Strategy.Cluster({distance:l,threshold:a}),new OpenLayers.Strategy.Refresh({force:!0,interval:g*1E3})],style:k,protocol:new OpenLayers.Protocol.HTTP({url:c,
format:S3.gis.format_kml})});b.title=e;b.body=f;b.setVisibility(h);b.events.on({featureselected:onKmlFeatureSelect,featureunselected:onFeatureUnselect});map.addLayer(b);S3.gis.layers_all.push(b)}var s3_gis_scaleImage=function(){var a=S3.gis.image.height/S3.gis.image.width,b=Math.min(S3.gis.image.width,S3.gis.max_w);a*=b;if(a>S3.gis.max_h)a=S3.gis.max_h,b*=b/a;S3.gis.image.height=a;S3.gis.image.width=b};
function addOSMLayer(a){var b=a.name,c=[a.url1];void 0!=a.url2&&c.push(a.url2);void 0!=a.url3&&c.push(a.url3);var d=void 0!=a.visibility?a.visibility:!0,b=new OpenLayers.Layer.TMS(b,c,{type:"png",getURL:osm_getTileURL,displayOutsideMaxExtent:!0,numZoomLevels:void 0!=a.zoomLevels?a.zoomLevels:19,isBaseLayer:void 0!=a.base?a.base:!0});if(void 0!=a.attribution)b.attribution=a.attribution;b.setVisibility(d);map.addLayer(b)}
function osm_getTileURL(a){var b=this.map.getResolution(),c=Math.round((a.left-this.maxExtent.left)/(b*this.tileSize.w)),a=Math.round((this.maxExtent.top-a.top)/(b*this.tileSize.h)),b=this.map.getZoom(),d=Math.pow(2,b);return a<0||a>=d?OpenLayers.Util.getImagesLocation()+"404.png":(c=b+"/"+(c%d+d)%d+"/"+a+"."+this.type,a=this.url,a instanceof Array&&(a=this.selectUrl(c,a)),a+c)}
...
function addWFSLayer(a){var b=a.name,c=a.title,d=void 0!=a.styleField?a.styleField:"",e=void 0!=a.styleValues?a.styleValues:{},f=void 0!=a.visibility?a.visibility:!0,g=void 0!=a.opacity?a.opacity:1,h=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance,j=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold,a=new OpenLayers.Protocol.WFS({version:void 0!=a.version?a.version:"1.1.0",srsName:void 0!=a.projection?"EPSG:"+a.projection:"EPSG:4326",url:a.url,featureType:a.featureType,
featureNS:a.featureNS,geometryName:void 0!=a.geometryName?a.geometryName:"the_geom",schema:a.schema}),l={context:{radius:function(a){var b=12;a.cluster&&(b=Math.min(a.attributes.count/2,8)+12);return b},fill:function(a){var b="#f5902e";a.cluster&&(b="#8087ff");return b},stroke:function(a){var b="#f5902e";a.cluster&&(b="#2b2f76");return b},label:function(a){var b="";if(a.cluster&&a.attributes.count>1)b=a.attributes.count;return b}}};if(d&&e)l.context.fill=function(a){var b;$.each(e,function(c,e){c==
a.attributes[d]&&(b=e)});b||(b="#f5902e");a.cluster&&(b="#8087ff");return b},l.context.stroke=function(a){var b;$.each(e,function(c,e){c==a.attributes[d]&&(b=e)});b||(b="#f5902e");a.cluster&&(b="#2b2f76");return b};g=new OpenLayers.Style({label:"${label}",pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:g/2,strokeColor:"${stroke}",strokeWidth:2,strokeOpacity:g},l);g=new OpenLayers.StyleMap({"default":g,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});projection=!projection||"4326"==projection?
S3.gis.proj4326:new OpenLayers.Projection("EPSG:"+projection);b=new OpenLayers.Layer.Vector(b,{maxFeatures:1E3,strategies:[new OpenLayers.Strategy.BBOX({ratio:1,resFactor:1}),new OpenLayers.Strategy.Cluster({distance:h,threshold:j})],projection:projection,protocol:a,styleMap:g});b.title=c;b.setVisibility(f);b.events.on({featureselected:onWfsFeatureSelect,featureunselected:onFeatureUnselect});map.addLayer(b);S3.gis.layers_all.push(b)}
function addWMSLayer(a){var b=void 0!=a.base?a.base:!1,c=void 0!=a.transparent?a.transparent:!0,d=void 0!=a.format?a.format:"image/png",e=void 0!=a.version?a.version:"1.1.1",f=void 0!=a.map?a.map:"",g=void 0!=a.style?a.style:"",h=void 0!=a.bgcolor?"0x"+a.bgcolor:"",j=void 0!=a.buffer?a.buffer:0,l=void 0!=a.tiled?a.tiled:!1,k=void 0!=a.opacity?a.opacity:1,a=new OpenLayers.Layer.WMS(a.name,a.url,{layers:a.layers},{wrapDateLine:!0,isBaseLayer:b,visibility:void 0!=a.visibility?a.visibility:!0});if(f)a.params.MAP=
f;if(d)a.params.FORMAT=d;if(c)a.params.TRANSPARENT=!0;if(e)a.params.VERSION=e;if(g)a.params.STYLES=g;if(h)a.params.BGCOLOR=h;if(l)a.params.TILED=!0,a.params.TILESORIGIN=[map.maxExtent.left,map.maxExtent.bottom];if(!b)a.opacity=k,a.buffer=j?j:0;map.addLayer(a)}
function addYahooLayers(){var a=S3.gis.Yahoo,b;a.Satellite&&(b=new OpenLayers.Layer.Yahoo(a.Satellite,{type:YAHOO_MAP_SAT,sphericalMercator:!0}),map.addLayer(b));a.Maps&&(b=new OpenLayers.Layer.Yahoo(a.Maps,{sphericalMercator:!0}),map.addLayer(b));a.Hybrid&&(b=new OpenLayers.Layer.Yahoo(a.Hybrid,{type:YAHOO_MAP_HYB,sphericalMercator:!0}),map.addLayer(b))}
...
g+="<li>"+e+"</li>";g+="</ul>";g+="<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+c.lon+","+c.lat+", 3)'>Zoom in</a></div>"}else if(void 0!=a.attributes.url)g=S3.i18n.gis_loading+"...<img src='"+S3.gis.ajax_loader+"' border=0 />";else{e=void 0==a.attributes.name?"":"<h3>"+a.attributes.name+"</h3>";f=void 0==a.attributes.description?"":"<p>"+a.attributes.description+"</p>";g=void 0==a.attributes.link?"":'<a href="'+a.attributes.link+'" target="_blank">'+a.attributes.link+"</a>";
if(void 0==a.attributes.data)h="";else if(a.attributes.data.indexOf("http://")===0)var d=!0,j=S3.uid(),h='<div id="'+j+'">'+S3.i18n.gis_loading+"...<img src='"+S3.gis.ajax_loader+"' border=0 /></div>";else h="<p>"+a.attributes.data+"</p>";var l=void 0==a.attributes.image?"":a.attributes.image.indexOf("http://")===0?'<img src="'+a.attributes.image+'" height=300 width=300>':"",g=e+f+g+h+l}c=new OpenLayers.Popup.FramedCloud(b,c,new OpenLayers.Size(200,200),g,null,!0,onPopupClose);void 0!=a.attributes.url?
s3_gis_loadDetails(a.attributes.url,b+"_contentDiv",c):d&&s3_gis_loadDetails(a.attributes.data,j,c);a.popup=c;map.addPopup(c)}function onGpxFeatureSelect(a){s3_gis_tooltipUnselect(a)}
function onKmlFeatureSelect(a){s3_gis_tooltipUnselect(a);for(var a=a.feature,b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat(),d=a.layer.title,e=a.attributes,f=typeof e[d],d="object"==f?e[d].value:e[d],g=a.layer.body.split(" "),h="",j=0;j<g.length;j++)f=typeof e[g[j]],"object"==f?(f=e[g[j]].displayName,f==""&&(f=g[j]),f="<b>"+f+"</b>: "+e[g[j]].value+"<br />"):f=e[g[j]]+"<br />",h+=f;h.search("<script")!=-1&&(h="Content contained Javascript! Escaped content below.<br />"+h.replace(/</g,"<"));
b=new OpenLayers.Popup.FramedCloud(b,c,new OpenLayers.Size(200,200),"<h3>"+d+"</h3>"+h,null,!0,onPopupClose);a.popup=b;map.addPopup(b)}
function onWfsFeatureSelect(a){s3_gis_tooltipUnselect(a);var a=a.feature,b=S3.uid(),c=a.geometry.getBounds().getCenterLonLat(),d=a.layer.title;if(a.cluster){for(var e,f=S3.i18n.gis_cluster_multiple+":<ul>",g=Math.min(a.cluster.length,9),h=0;h<g;h++)e=a.cluster[h].attributes[d],f+="<li>"+e+"</li>";f+="</ul>";f+="<div align='center'><a href='javascript:s3_gis_zoomToSelectedFeature("+c.lon+","+c.lat+", 3)'>Zoom in</a></div>"}else{e=a.attributes;var d=e[d],j="";$.each(e,function(a,b){j+="<b>"+a+":</b> "+
b+"<br />"});f="<h3>"+d+"</h3>"+j}b=new OpenLayers.Popup.FramedCloud(b,c,new OpenLayers.Size(200,200),f,null,!0,onPopupClose);a.popup=b;map.addPopup(b)}
...
function addPopupControls(){S3.gis.popupControl=new OpenLayers.Control.SelectFeature(S3.gis.layers_all,{toggle:!0,clickout:!0,multiple:!0});S3.gis.highlightControl=new OpenLayers.Control.SelectFeature(S3.gis.layers_all,{hover:!0,highlightOnly:!0,eventListeners:{featurehighlighted:s3_gis_tooltipSelect,featureunhighlighted:s3_gis_tooltipUnselect}});map.addControl(S3.gis.highlightControl);map.addControl(S3.gis.popupControl);S3.gis.highlightControl.activate();S3.gis.popupControl.activate()}
...
function addGoogleEarthControl(a){var b=new Ext.Toolbar.Button({iconCls:"googleearth",tooltip:S3.gis.Google.Earth,enableToggle:!0,toggleHandler:function(a,b){b===!0?(S3.gis.mapPanelContainer.getLayout().setActiveItem(1),S3.gis.mapWin.items.items[0].collapse(),S3.gis.googleEarthPanel.on("earthready",function(){addGoogleEarthKmlLayers()})):(S3.gis.mapPanelContainer.getLayout().setActiveItem(0),S3.gis.mapWin.items.items[0].expand())}});a.addSeparator();a.addButton(b)}
...
function addGoogleStreetviewControl(a){var b=OpenLayers.Class(OpenLayers.Control,{defaults:{pixelTolerance:1,stopSingle:!0},initialize:function(){this.handlerOptions=OpenLayers.Util.extend({},this.defaults);OpenLayers.Control.prototype.initialize.apply(this,arguments);this.handler=new OpenLayers.Handler.Click(this,{click:this.trigger},this.handlerOptions)},trigger:function(a){openStreetviewPopup(map.getLonLatFromViewPortPx(a.xy))}});S3.gis.StreetviewClicker=new b({autoactivate:!1});map.addControl(S3.gis.StreetviewClicker);
b=new Ext.Toolbar.Button({iconCls:"streetview",tooltip:S3.gis.Google.StreetviewButton,toggleGroup:"controls",allowDepress:!0,enableToggle:!0,toggleHandler:function(a,b){b===!0?S3.gis.StreetviewClicker.activate():S3.gis.StreetviewClicker.deactivate()}});a.addSeparator();a.addButton(b)}
...
toggleGroup:"controls",allowDepress:!0,enableToggle:!0});c=new GeoExt.Action({control:c,map:map,iconCls:"measure-area",tooltip:S3.i18n.gis_area_tooltip,toggleGroup:"controls",allowDepress:!0,enableToggle:!0});a.add(b);a.add(c)}
...
$(".olMapViewport").removeClass("crosshair")},map:map,iconCls:"drawpolygon-off",tooltip:S3.i18n.gis_draw_polygon,toggleGroup:"controls",allowDepress:!0,pressed:b,enableToggle:!0,activateOnEnable:!0,deactivateOnDisable:!0});a.add(S3.gis.polygonButton)}
