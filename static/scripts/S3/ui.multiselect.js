 ...
 *
 * Modified by Fran Boon for S3 i18n 
 *
 * Depends:
 *	ui.core.js
 *	ui.sortable.js
 *
 * Optional:
 * (localization (http://plugins.jquery.com/project/localisation)) <- No longer
...
$.widget("ui.multiselect", {
  options: {
	...
	_getOptionNode: function(option) {
		...
		var node = $('<li class="ui-state-default ui-element" title="'+option.text()+'"><span class="ui-icon"/><a href="#" class="action">'+option.text()+'<div class="plusminus"><span class="ui-corner-all ui-icon"/></div></a></li>').hide();
