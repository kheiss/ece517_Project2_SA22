...
# Also requires Human Resources & Asset modules
if deployment_settings.has_module(module):
    ...
    def scenario_tables():
        ...
        if deployment_settings.has_module("hrm"):
            ...
            s3mgr.model.add_component(table, scenario_scenario="scenario_id")
        ...
        # ---------------------------------------------------------------------
        # Assets
        # @ToDo: Use generic Supply Items not Asset instances?
        ...
        s3mgr.model.add_component(table,
                                  scenario_scenario=dict(joinby="scenario_id",
                                                         multiple=False))
    ...
    s3mgr.configure("scenario_scenario", resolve=scenario_scenario_duplicate)
