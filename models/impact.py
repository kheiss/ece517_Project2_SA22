...
if deployment_settings.has_module("irs") or \
   deployment_settings.has_module("assess"):
    ...
    def impact_tables():
        ...
        if deployment_settings.has_module("irs"):
            # Impact as component of incidents
            s3mgr.model.add_component(table, irs_ireport="ireport_id")
        if deployment_settings.has_module("assess"):
