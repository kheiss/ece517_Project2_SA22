...
s3_menu_dict = {
    ...
    "asset": {
        "menu": [
            ...
            [
                [T("New"), False, aURL(p="create", c="supply", f="item",
                                      args="create")],
    ...
    "delphi": {
        "menu": [
            #[T("Active Problems"), False, URL(f="index")],
    ...
    # FLOOD / Flood Alerts Module
    # -------------------------------------------------------------------------
    "flood": {
        "menu": [
            [T("Flood Reports"), False, aURL(f="freport"),[
                [T("New"), False, aURL(p="create", f="freport", args="create")],
                [T("List All"), False, aURL(f="freport")],
                #[T("Search"), False, aURL(f="freport", args="search")]
            ]],
        ]
    },
             ...
             False, aURL(f="index"), [
               [T("New Staff Member"),
                ...
                [T("List All"),
                 False, aURL(f="human_resource")],
                [T("Import"),
                 False, aURL(p="create", f="person", args=["import.xml"])],
                [T("Dashboard"),
                 False, aURL(f="index")],
            ]],
    ...
    "importer": {
        "menu": [
            [
        	    T("Upload Spreadsheet"), False, aURL(f="spreadsheet", args=["create"])
            ],
            [T("Upload Comma Separated Value File"), False, aURL(f="csv", args=["create"])]
        ]
    },
    ...
    "irs": {
        "menu": [
            [T("Incident Reports"), False, aURL(f="ireport"),[
                ...
                [T("Timeline"), False, aURL(f="irs_timeline")],
                #[T("Search"), False, aURL(f="ireport", args="search")]
            ]],
        ],
    ...
    "survey": {
        "menu": [
            [T("Templates"), False, aURL(f="template"), [
...
#                [T("List All"), False, aURL(f="section")]]],
            [T("Series"), False, aURL(f="series"), [
                [T("New"), False, aURL(p="create", f="series", args="create")],
                [T("List All"), False, aURL(f="series")],
                [T("Map of Assessments"), False, aURL(f="series_map")],
            ]],
            [T("Response"), False, aURL(f="complete"), [
...
#                [T("List All"), False, aURL(f="complete")],
    ...
    "project": {
        "menu": [
            ...
            [T("Projects"), False, aURL(f="project"),[
                [T("New"), False, aURL(p="create", f="project", args="create")],
                [T("List All"), False, aURL(f="project")],
                #[T("Search"), False, aURL(f="organisation", args="search")]
            ]],
            [T("Activities"), False, aURL(f="activity"),[
                [T("New"), False, aURL(p="create", f="activity", args="create")],
                [T("List All"), False, aURL(f="activity")],
                #[T("Search"), False, aURL(f="project", args="search")]
            ]],
            [T("Tasks"), False, aURL(f="task"),[
                [T("New"), False, aURL(p="create", f="task", args="create")],
                [T("List All"), False, aURL(f="task")],
                #[T("Search"), False, aURL(f="office", args="search")]
            ]],
            [T("Gap Analysis"), False, aURL(f="gap_report"),[
                [T("Report"), False, aURL(f="gap_report")],
                [T("Map"), False, aURL(f="gap_map")],
            ]],
        ],
    ...
    "ticket": {
        "menu": [
            [T("Home"), False, URL(f="index")],
            [T("New Ticket"), False, aURL(p="create", f="log", args="create")],
            # New Ticket changed to aURL, not completely sure, but a presence of p hints for it
            [T("View All Tickets"), False, URL(f="log")],
            #[T("Search Tickets"), False, URL(f="log", args="search")] #disabled due to problems with pagination
        ]
    },
