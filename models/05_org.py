...
if deployment_settings.get_ui_cluster():
    ...
    s3.crud_strings[tablename] = Storage(
        ...
        label_create_button = T("Add Cluster"),
...
def org_sector_duplicate(job):
    ...
    if job.tablename == "org_sector":
        table = job.table
        abrv = "abrv" in job.data and job.data.abrv
...
s3mgr.configure("org_sector", resolve=org_sector_duplicate)
...
def organisation_controller():
    ...
    #tabs.append((T("Donors"), "organisation"))
